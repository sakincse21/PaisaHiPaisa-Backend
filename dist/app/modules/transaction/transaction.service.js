...
const addMoney = (payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const data = {
            ...
            success_url: `${env_1.envVars.BACKEND_URL}${env_1.envVars.SSL.SUCCESS_URL}?trans_id=${transaction[0]._id}`,
            fail_url: `${env_1.envVars.BACKEND_URL}${env_1.envVars.SSL.FAIL_URL}?trans_id=${transaction[0]._id}`,
            cancel_url: `${env_1.envVars.BACKEND_URL}${env_1.envVars.SSL.CANCEL_URL}?trans_id=${transaction[0]._id}`,
            shipping_method: "N/A",
