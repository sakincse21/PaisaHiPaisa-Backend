...
router.post('/withdraw',authCheck(IRole.USER, IRole.MERCHANT),validateRequest(createTransactionZodSchema),TransactionControllers.withdrawMoney)
...
router.post('/payment',authCheck(IRole.USER),validateRequest(createTransactionZodSchema),TransactionControllers.payment)
